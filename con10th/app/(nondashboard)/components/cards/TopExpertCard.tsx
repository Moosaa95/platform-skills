...
export function ExpertCard({
  ...
  return (
    <div 
      className={`min-w-[280px] sm:min-w-[300px] flex-shrink-0 bg-white rounded-lg border border-gray-200 overflow-hidden snap-start hover:shadow-md transition-shadow duration-200 ${className}`}
      onClick={onClick}
    >
      <div className="p-4">
